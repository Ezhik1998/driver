...
import 'dart:async';
import 'package:driver/models/sensorInfoHolder.dart';
...
class _SensorMainState extends State<SensorMainHome> {
  static String _methodChannelName =
      'com.example.driver.androidMethodChannel'; // keep it unique
  static String _eventChannelName =
      'com.example.driver.androidEventChannel'; // keep it unique too
